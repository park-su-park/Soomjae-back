...
@Getter
public class MemberPostDetailResponse {
    ...
    public MemberPostDetailResponse(MemberPost memberPost, Member member,
        LikeStatusResponse likeStatusResponse, Long commentCount, List<CommentResponse> comments) {
        ...
        memberPost.getImages()
            .forEach(memberPostImage -> this.images.add(memberPostImage.getImageUrl()));
